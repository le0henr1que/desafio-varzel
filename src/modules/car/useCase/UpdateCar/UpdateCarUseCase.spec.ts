...
describe("POST /update/:id/auto", () => {
  ...
  it("should update car and return jwt expired", async () => {
    ...
    const validJwt =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYzNWQ1ZTk0MDAwNzBlMjE5YWNkOTZkZiIsImlhdCI6MTY2NzE0MDM3NywiZXhwIjoxNjY3MTYxOTc3fQ.GVnbTIn6tjwHO3RU72VwAVYJSUdQ0bu7BPEG1sRttzY";
